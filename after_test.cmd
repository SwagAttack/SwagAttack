REM nuget install NUnit.Console -OutputDirectory tools
REM nuget install OpenCover -Version 4.6.519 -OutputDirectory tools
REM nuget install coveralls.net -Version 0.412.0 -OutputDirectory tools
REM cd tools
...
REM coveralls.net.0.412\tools\csmacnz.Coveralls.exe --opencover -i ..\SwagAttack_Gameserver_Mirror\GameServer\ITTestCore\coverage.xml --jobId %APPVEYOR_BUILD_NUMBER%
