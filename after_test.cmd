...
dotnet test C:\projects\swagattack\SwagAttack_Gameserver_Mirror\GameServer\ITTestCore\IT_Core.csproj --no-build --no-restore --logger:Appveyor /p:Exclude=D:/repos/nunit/nunit3-vs-adapter/src/NUnitTestAdapter/*.cs /p:CollectCoverage=true /p:CoverletOutputFormat=opencover
