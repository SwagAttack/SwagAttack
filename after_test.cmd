...
dotnet test C:\projects\swagattack\SwagAttack_Gameserver_Mirror\GameServer\ITTestCore\IT_Core.csproj --no-build --no-restore --logger:Appveyor /p:Exclude=D:\* /p:CollectCoverage=true /p:CoverletOutputFormat=opencover
